...
import { Home, Map, User, GraduationCap, X } from 'lucide-react';
...
const menuItems = [
  ...
  { id: 'profile', label: 'My Progress', icon: User },
];

export function AppSidebar({ currentPage, onNavigate, isOpen = true, onClose }: AppSidebarProps) {
  return (
    <>
      {/* Mobile overlay */}
      {isOpen && (
